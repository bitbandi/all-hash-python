...
class Test(TestCase):
    ...
    def test_powhash(self):
        ...
        hash_bin = pentablake_hash.getPoWHash(testbin)
        self.assertEqual(hash_bin, unhexlify('fa10373872f60649efbf18bfba6bd46cef2ff319c7a568d1179c37e0ec4d383e'))
